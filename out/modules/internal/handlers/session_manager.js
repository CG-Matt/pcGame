...
import { Router, Computer, Web } from "../classes/devices.js";
                    ...
                    for await (const file_name of files) {
                        ...
                        if (file) {
                            if (file.type == "executable") {
                                this.websites.fetch(main.name).files.insert(new ExecutableFile(file.name, file.execute));
                            }
                            else {
                                this.websites.fetch(main.name).files.insert(new GenericFile(file.name, "text"));
                            }
                        }
                    }
                }
